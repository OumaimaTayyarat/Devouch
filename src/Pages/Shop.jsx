...
//         tableLoader.load("/power_station._destructions.glb", object => {
    
//           object.scene.position.set(-5, -5, 1);
//           object.scene.rotation.y = Math.PI * 0.5 +Math.PI * 0.01;
...
//         var tableLoader = new GLTFLoader(manager);
//         tableLoader.load("/corkboard_31mb.glb", object => {
...
//         tvGroup.position.z = 0;
//         tvGroup.position.y = 1000;

//         this.scene.add( tvGroup );
        
//         var tableLoader = new GLTFLoader(manager);
//         tableLoader.load("/prosp_1_from_wall_tube_mechanism_props.glb", object => {
